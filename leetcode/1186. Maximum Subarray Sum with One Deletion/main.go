...
with at most one element deletion. In other words, you want to choose
a subarray and optionally delete one element from it so that there is
...
func maximumSum(arr []int) int {
	...
	for _, v := range arr {
		dp = append(dp, []int{MinInt, MinInt})
	}
